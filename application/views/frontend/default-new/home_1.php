...
<section class="student py-5 ">
    <div class="container">
       ...
       <?php
    // تحديد الاتجاه بناءً على اللغة المختارة
    $direction = (get_settings('language') == 'arabic') ? 'rtl' : 'ltr';
    $text_align = ($direction == 'rtl') ? 'right' : 'left';
?>
<div class="row"  data-wow-duration="1000" data-wow-delay="700">
    <div class="col-lg-6 <?php if (get_settings('allow_instructor') != 1) echo 'w-100'; ?> wow animate_animated animate_fadeInUp opacityOnUp" data-wow-duration="1000" data-wow-delay="650">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="student-body-text">
                        ...
                        <a href="<?php echo site_url('sign_up'); ?>" class="btn btn-primary">
                            <?php echo site_phrase('get_started'); ?>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <?php if ($direction == 'rtl'): ?>
                        <!-- عرض الصورة فقط إذا كان الاتجاه RTL -->
