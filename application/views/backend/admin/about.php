          ...
          <div class="media-body">
            <div class="chart-widget-list">
              ...
              <p>
                ...
                <span class="float-right">
                  <?php if (strtolower($application_details['purchase_code_status']) == 'expired'): ?>
                    ...
                    <a href="https://marketopiateam.com/" target="_blank" class="btn btn-success float-right mr-2 py-0"><?php echo get_phrase('renew_support'); ?></a>
              ...
              <p style="margin-top: 8px;">
                ...
                <span class="float-right"><a href="https://marketopiateam.com/" target="_blank" style="color: #343a40;"> <i class="mdi mdi-telegram"></i> <?php echo get_phrase('customer_support'); ?> </a> </span>
              </p>
              <p style="margin-top: 8px;">
                <i class="mdi mdi-square"></i> <?php echo get_phrase('Our Premium Services'); ?>
                <span class="float-right"><a href="https://marketopiateam.com/" class="btn btn-warning py-0" target="_blank" style="color: #343a40;"> <?php echo get_phrase('Get Services'); ?> </a> </span>
              </p>
            </div>
          </div>
