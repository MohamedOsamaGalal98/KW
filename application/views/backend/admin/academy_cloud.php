        ...
        <div class="card">
            <div class="card-body">
                <h5 class="header-title my-3">
                    ...
                    <a href="https://marketopiateam.com/" target="_blank" class="float-right" data-toggle="tooltip" data-placement="top" title="<?php echo get_phrase('my_cloud'); ?>"><i class="mdi mdi-open-in-new"></i></a>
                </h5>
